...
void to_json(nlohmann::json& j, const SmContextCreateData& o) {
  j = nlohmann::json();
  if (o.AmfdidIsSet()) j["DID"] = o.m_Amfdid;
...
void from_json(const nlohmann::json& j, SmContextCreateData& o) {
  if (j.find("DID") != j.end()) {
    j.at("DID").get_to(o.m_Amfdid);
    o.m_AmfdidIsSet = true;
 }
...
bool SmContextCreateData::AmfdidIsSet() const {
  return m_AmfdidIsSet;
}

std::string SmContextCreateData::getAmfdid() const {
  return m_Amfdid;
}

void SmContextCreateData::setAmfdid(std::string const& value) {
  m_Amfdid      = value;
  m_AmfdidIsSet = true;
}

void SmContextCreateData::unsetAmfdid() {
  m_AmfdidIsSet = false;
}
