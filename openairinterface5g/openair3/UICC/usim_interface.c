...
#define UICC_PARAMS_DESC {                                              \
      {"imsi",             "USIM IMSI\n",          0,         .strptr=&uicc->imsiStr,              .defstrval="208950000000031",           TYPE_STRING,    0 }, \
      {"nmc_size"          "number of digits in NMC", 0,      .iptr=&uicc->nmc_size,               .defintval=2,         TYPE_INT,       0 }, \
      {"key",              "USIM Ki\n",            0,         .strptr=&uicc->keyStr,               .defstrval="0C0A34601D4F07677303652C0462535B", TYPE_STRING,    0 }, \
      {"opc",              "USIM OPc\n",           0,         .strptr=&uicc->opcStr,               .defstrval="63bfa50ee6523365ff14c1f45f88737d", TYPE_STRING,    0 }, \
