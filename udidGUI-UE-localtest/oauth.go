...
func (im *infoManager) makeOAuthLayout() fyne.CanvasObject {
	...
	btn0 := widget.NewButton("Run Demo", func() {
		...
		go im.init_05(entry, scrollContainer, image, imgs)
	})
...
func (im *infoManager) init_05(output *widget.Entry, scroll *container.Scroll, image *canvas.Image, imgs []fyne.Resource) {
